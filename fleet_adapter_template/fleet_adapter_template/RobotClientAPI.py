...
class RobotAPI:
    ...
    # http requests. Users should modify the constructor as per the requirements
    # of their robot's API
    ...
    def start_process(self, process:str, map_name:str):
        ''' Request the robot to begin a process. This is specific to the robot
            and the use case. For example, load/unload a cart for Deliverybot or
            begin cleaning a zone for a cleaning robot.
